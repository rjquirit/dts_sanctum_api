    ...
    docs.forEach(doc => {
        ...
        tr.innerHTML = `
            ...
            <input type="hidden" class="doc-id" name="action_id" value="${escapeHtml(doc.action_id)}">
                ...
                <button class="btn btn-sm btn-primary view" aria-label="Edit Route">
 ...
 */
export async function loadDocs(tableBodySelector, url = '/api/documents/mydocs?${params.toString()}') {
