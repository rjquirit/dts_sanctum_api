            ...
            <div class="row mb-3">
                <div class="col-md-3">
                    <div class="form-check form-switch">
                        ...
                        <label class="form-check-label" for="toggleSwitch">Show Personal Created Documents</label>
                    </div>
...
@push('scripts')
<script type="module" src="{{ asset('js/doc_mydocs.js') }}"></script>
@endpush
